...
async function notifyEntryDeleted(id) {
  const pusher = getPusherClient();
  await pusher.trigger(CHANNEL, DELETE_EVENT, { id });
}

module.exports = { notifyNewEntry, notifyEntryDeleted, CHANNEL, EVENT, DELETE_EVENT };
